CLASS zrd_at_data_builder DEFINITION PUBLIC FINAL CREATE PUBLIC.
  PUBLIC SECTION.
...
CLASS zrd_at_data_builder IMPLEMENTATION.
...
*        output =̥
  ...
  METHOD fill_master_data.
    data : lt_bp type table of zrd_at_bpa,
           lt_prod type table of zrd_at_product.
   ...
   append value #(
    ...
    append value #(
     ...
     insert zrd_at_bpa from table @lt_bp.
     insert zrd_at_product from table @lt_prod.
  ENDMETHOD.
  ...
  METHOD fill_transaction_data.
    data : o_rand type REF TO cl_abap_random_int,
           ...
           lv_ord_id type zrd_at_dte_id,
           lt_so type table of zrd_at_so_hdr,
           lt_so_i type table of zrd_at_so_item.
    ...
    select * from zrd_at_bpa into table @data(lt_bpa).
    select * from zrd_at_product into table @data(lt_prod).
        ...
        do 2 times.
            ...
            TRY.
                APPEND VALUE #(
                    ...
                    qty =  n
                    uom = 'EA'
                    gross_amount =  n * ls_prod-price
                    currency_code = ls_prod-currency
             ) TO lt_so_i.
              CATCH cx_uuid_error.
                "handle exception
            ENDTRY.
    ...
    insert zrd_at_so_hdr from table @lt_so.
    insert zrd_at_so_item from table @lt_so_i.

  ENDMETHOD.

  METHOD flush.
    delete from : zrd_at_bpa, zrd_at_product, zrd_at_so_hdr, zrd_at_so_item.
  ENDMETHOD.
